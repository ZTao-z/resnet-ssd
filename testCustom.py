...
parser.add_argument('--trained_model', default='weights/CUSTOM.pth',
...
parser.add_argument('--voc_root', default=CUSTOM_ROOT, help='Location of VOC root directory')
...
def test_voc():
    ...
    # load data
    testset = customDetection(args.voc_root, [('shenhe', 'test')], None, customAnnotationTransform())
    if args.cuda:
        net = net.cuda()
